...
const formulas = [
    ...
    { 
        ...
        formula: "\\small \\text{clique pour voire plus}", 
        definition: "Tableau complet : \\[ \\footnotesize \\begin{array}{|c|c|c|c|c|} \\hline \\text{Eq.} & Cu & + & 2Ag^+ & \\rightarrow & Cu^{2+} & + & 2Ag \\\\ \\hline x=0 & n_1 & & n_2 & & 0 & & 0 \\\\ \\hline x & n_1-x & & n_2-2x & & x & & 2x \\\\ \\hline x_{max} & n_1-x_{max} & & n_2-2x_{max} & & x_{max} & & 2x_{max} \\\\ \\hline \\end{array} \\]",
